      ...
      <details class="card" id="timerCard">
        <summary class="sum">
          <div class="cardTitle">
            ...
            <div>
              <div class="sumTitle">העדפות טיימר</div>
        ...
        <div class="content">
          ...
          <details class="subdetails" id="manualDetails">
            <summary class="subsum">
              <div>שליטה ידנית</div>
              <svg class="chev"><use href="#i-chevron" /></svg>
            </summary>
            <div class="content">
              <div class="row">
                <div class="inline">
                  ...
                  <div>
                    <div class="label">מצב ידני</div>
                    <div class="muted">כשמופעל, הלוח לא שולט בריליי</div>
                  </div>
                </div>
              </div>

              <div class="row" id="manualRelayRow" style="display: none">
                <div class="inline">
                  <label class="switch">
                    <input id="manualRelayOn" type="checkbox" />
                    <span></span>
                  </label>
                  <div>
                    <div class="label">ריליי דלוק</div>
                    <div class="muted">שליטה ידנית</div>
                  </div>
                </div>
              </div>
            </div>
